		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
{{-- {{ route('update.fee.amount',$editData[0]->fee_category_id) }} --}}
 <form method="post" action="{{ route('update.fee.amount',$editData[0]->fee_category_id) }}">
	...
	<h5>School Bill<span class="text-danger">*</span></h5>
	<div class="controls">
	 <select name="fee_category_id" required="" class="form-control">
		<option value="" selected="" disabled="">Select School Bill</option>
