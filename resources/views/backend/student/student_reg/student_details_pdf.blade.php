...
<table id="customers">
  ...
  <tr>
    ...
    <td>{{ $allData['student']['fathername'] }}</td>
  </tr>
  <tr>
    <td>5</td>
    <td><b>Mother's Name</b></td>
    <td>{{ $allData['student']['mothername'] }}</td>
  </tr>
  <tr>
    <td>6</td>
  ...
  <tr>
    ...
    <td>9</td>
    <td><b>Religion</b></td>
    <td>{{ $allData['student']['religion'] }}</td>
  </tr>
    ...
    <td>{{ $allData['student']['birthday'] }}</td>
  </tr>
    {{-- <tr>
    <td>11</td>
    <td><b>Discount </b></td>
    ...
    <td>12</td>
    <td><b>Class  </b></td>
    <td>{{ $allData['Class']['name'] }}</td>
  </tr>
    <tr>
    <td>13</td>
    <td><b>Stream </b></td>
    <td>{{ $allData['Stream']['name'] }}</td>
  </tr>
    <tr>
    <td>14</td>
    <td><b>Shift </b></td>
    <td>{{ $allData['Shift']['name'] }}</td>
  </tr>
