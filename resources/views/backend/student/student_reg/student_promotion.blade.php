		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
{{-- {{ route('promotion.student.registration',$editData->student_id) }} --}}
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="text" name="fathername" class="form-control" required=""  value="{{ $editData['student']['fname'] }}" >
	  </div>
	  </div>
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="text" name="fathername" class="form-control" required=""  value="{{ $editData['student']['mname'] }}">
	  </div>
	  </div>
...
<div class="col-md-4">
 ...
 <option value="Christan"{{ ($editData['student']['religion'] == 'Christan')? 'selected':'' }}>Christan</option>
		...
		<div class="controls">
	 <input type="date" name="birthday" class="form-control" required="" value="{{ $editData['student']['dob'] }}" >
	  </div>
	  </div>
...
<div class="col-md-4">
 		...
 		<div class="form-group">
		<div class="controls">
	<img id="showImage" src="{{ (!empty($editData['student']['image']))? url('upload/student_images/'.$editData['student']['images']):url('upload/no_image.jpg') }}" style="width: 100px; width: 100px; border: 1px solid #000000;">
