		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
                    {{-- {{ route('store.employee.registration') }} --}}
	 <form method="post" action="{{ route('teacher.registration.store') }}" enctype="multipart/form-data">
	 	@csrf
					  <div class="row">
						<div class="col-12">
	            ...
	            <div class="row"> <!-- 2nd Row -->
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                            <input type="integer" name="mobile" class="form-control" required="" >
                            </div>
                            </div>
